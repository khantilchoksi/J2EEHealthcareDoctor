...
import com.khantilchoksi.j2eehealthcaredoctor.Clinic;
...
public class GetDoctorClinicSlotsTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public GetDoctorClinicSlotsTask(Context context, Activity activity, AsyncResponse delegate, ProgressDialog progressDialog){
